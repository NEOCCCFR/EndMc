package fr.neocfr.endmc.web;

import com.google.common.util.concurrent.ThreadFactoryBuilder;
import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import fr.neocfr.endmc.dto.UserDTO;
import fr.neocfr.endmc.exceptions.RequestError;
import fr.neocfr.endmc.exceptions.ServerError;
import fr.neocfr.endmc.utils.EnumUtils;
...
public class Web {
    ...
    public CompletableFuture<UserDTO> createProfile(UserDTO playerProfileDTO) {
    ...
    public CompletableFuture<UserDTO> getProfileByUniqueId(UUID uniqueId) {
    ...
    private CompletableFuture<UserDTO> execute(String endpoint, Consumer<HttpRequest.Builder> builderConsumer) {
        ...
        return client.sendAsync(builder.build(), HttpResponse.BodyHandlers.ofString(StandardCharsets.UTF_8))
                .thenCompose(response -> {
                    ...
                    return CompletableFuture.completedFuture(GSON.fromJson(response.body(), UserDTO.class));
                });
    }
